...
export default function Login({ login }) {
  ...
  return (
    <div className='h-[900px] flex justify-center flex-col' >
          <form onSubmit={submitHandler} className="bg-f7f7f7 border border-gray-300 rounded p-6 my-6  w-[500px] " >
      <div className="flex flex-col w-96 h-24 mb-6">
        ...
        <input
          ...
          className={`border-2 p-2 rounded ${
            errors.email ? 'border-red-500 bg-red-200' : 'border-green-500 bg-green-200'
          }`}
        />
      ...
      <div className="flex flex-col w-96 h-24 mb-6">
        ...
        <input
          ...
          onChange={handleInputChange}
          className={`border-2 p-2 rounded ${
            errors.password ? 'border-red-500 bg-red-200' : 'border-green-500 bg-green-200'
          }`}
        />
